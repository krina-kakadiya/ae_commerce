        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.product.update',$postData['id']) }}" method="post"
                        id="productEditForm" enctype="multipart/form-data" class="row g-3">
                        @csrf

                        <div class="col-md-12 message">
                            <button class="btn btn-Light" id="imageDynamicDivBTN">
                                @foreach ($postData->images as $eachImage)
                                <img src="{{ asset('product-image/'.$eachImage['product_image']) }}"
                        ...
                        <div class="col-md-6 message">
                            ...
                            <select name="category" id="category" class="form-select" aria-hidden="true">
                                ...
                                <option value="{{ $item['id']}}" {{ $postData['category_id']==$item['id'] ? 'selected'
                        ...
                        <div class="col-md-4 message">
                            ...
                            <input type="text" name="price" id="price" value="{{ $postData['price'] }}"
                        ...
                        <div class="col-md-4 message">
                            ...
                            <input type="text" name="stock" id="stock" value="{{ $postData['stock'] }}"
                                class="form-control">
                        ...
                        <div class="col-md-4 message">
                            ...
                            <input type="text" name="shipping_fee" id="shipping_fee"
                                value="{{ $postData['shipping_fee'] }}" class="form-control">
                        </div>


                        <div class="col-md-4 message">
                            <label for="inputCity" class="form-label">Discount</label>
                            <input type="text" name="discount" id="discount" value="{{ $postData['discount'] }}"
                                class="form-control">
                        </div>
                        <div class="col-md-8 message">
                            <label for="inputState" class="form-label"> Select Discount Date Range </label>
                            <input type="text" name="date_range" id="date_range" class="form-control" value="{{ $dateRange }}" />
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-check">
                                <input type="radio" name="product_status" id="product_status" class="form-check-input"
                                    value="0" {{ $postData['product_status']==0 ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="radio" name="product_status" id="product_status" class="form-check-input"
                                    value="1" {{ $postData['product_status']==1 ? 'checked' : '' }}>
